# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-09-27 14:26
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Hliquidac',
            fields=[
                ('codigo', models.IntegerField(auto_created=True, blank=True, primary_key=True, serialize=False)),
                ...
                ('documento', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='persona.Persona', verbose_name='documento_id')),
            ],
        ),
        migrations.CreateModel(
            name='Mes',
